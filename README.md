...
NOTE: This script was written to merge the provide EQA sample; therefore, may not be suitable for other samples as the Filter columne is differnt between samples
